...
<head>
    ...
    <style>
        ...
        .dashboard-controls button.active, .dashboard-controls button:focus {
            background: #1877f2;
            color: #fff;
        ...
        @media (max-width: 900px) {
            ...
            .main-scroll { padding: 22px 2vw 22px 2vw; }
        }
        @media (max-width: 700px) {
            .sidebar { width: 100px; min-width: 0; }
            .parent-name { font-size: 1rem; padding-left: 12px; }
            .nav-btn { font-size: 0.97rem; padding: 10px 8px 10px 6px; }
            .sidebar-bottom { bottom: 16px; }
        }
        @media (max-width: 480px) {
            .sidebar { width: 60px; }
            .main-scroll { padding: 8px 1vw 8px 1vw; }
